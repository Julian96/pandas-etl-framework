...
def meta_column_delta(file_path):
...
def simulate_runs(first_run_file_path, second_run_file_path):
    if os.path.exists(current_path):
        shutil.rmtree(current_path)
    meta_column_delta(first_run_file_path)
    meta_column_delta(second_run_file_path)
...
if __name__ == '__main__':
    ...
    delta_final_df = simulate_runs(first_run_delta_path, second_run_delta_path)
    print(delta_final_df)

    
    first_run_full_path = './data/grades_full_old.csv'
    second_run_full_path = './data/grades_full_new.csv'
    full_final_df = simulate_runs(first_run_full_path, second_run_full_path)
    print(full_final_df)